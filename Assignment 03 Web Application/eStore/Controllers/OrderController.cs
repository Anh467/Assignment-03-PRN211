...
namespace eStore.Controllers
{
    ...
    {
        IOrderrRepository _orderrRepository;
        public OrderController()
        {
            _orderrRepository = new OrderrRepository();
        }
        // GET: OrderController
        ...
        public ActionResult Create(Orderr orderr)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, Orderr orderr)
        {
            try
            {
        ...
        public ActionResult Delete(int? id)
        {
            ...
            {
                if (id == null) return NotFound();
                Orderr orderr = _orderrRepository.Get(id.Value);
